...
/**
 * Implements a simple cache for remote URIs. Delegates methods to {@link Workspace} wherever possible.
 * <p>
...
public final class WorkspaceImpl implements Workspace {
  ...
  private static final String JMX_WORKING_FILE_REPOSITORY_TYPE = "WorkspaceRepository";
  ...
  public void activate(ComponentContext cc) throws IOException {
    ...
    registeredMXBean = JmxUtil.registerMXBean(workspaceBean, JMX_WORKING_FILE_REPOSITORY_TYPE);
    ...
    if (garbageCollectionPeriodInSeconds > 0 && maxAgeInDays > 0 && collectionsToCleanUp != null) {
      workspaceCleaner = new WorkspaceCleaner(this,
  ...
  public void delete(MediaPackageElement mpe) throws NotFoundException, IOException {
    delete(mpe.getMediaPackage().getIdentifier().toString(), mpe.getIdentifier());
  }
  ...
  public void delete(URI uri) throws NotFoundException, IOException {
    ...
    if (uriPath.startsWith(getBaseUri().toString())) {
      if (uriPath.indexOf(Workspace.COLLECTION_PATH_PREFIX) > 0) {
      ...
      } else if (uriPath.indexOf(Workspace.MEDIAPACKAGE_PATH_PREFIX) > 0) {
        isMediaPackage = true;
   ...
   * {@inheritDoc}
   *
   * @see org.opencastproject.workspace.api.Workspace#get(java.lang.String, java.lang.String)
   */
  public File get(String mediaPackageID, String mediaPackageElementID) throws NotFoundException {
  ...
  public File get(MediaPackageElement mpe) throws NotFoundException, IOException {
    return get(mpe.getMediaPackage().getIdentifier().toString(),
        mpe.getIdentifier());
  }

  public InputStream getStream(MediaPackageElement mpe) throws NotFoundException, IOException {
    return getStream(mpe.getMediaPackage().getIdentifier().toString(),
        mpe.getIdentifier());
  }
   ...
   * {@inheritDoc}
   *
   * @see org.opencastproject.workspace.api.Workspace#getCollectionURI(java.lang.String,
   * java.lang.String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencastproject.workspace.api.Workspace#put(java.lang.String, java.lang.String,
   ...
   */
  protected File getFile(String mediaPackageID, String mediaPackageElementID)
  ...
  public InputStream getFromCollectionStream(String collectionId, String fileName)
          throws NotFoundException, IOException {
   ...
   * @see org.opencastproject.workspace.api.Workspace#putInCollection(java.lang.String,
   * java.lang.String, java.io.InputStream)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.opencastproject.workspace.api.Workspace#moveTo(java.lang.String, java.lang.String,
   ...
   * {@inheritDoc}
   *
   * @see org.opencastproject.workspace.api.Workspace#deleteFromCollection(java.lang.String,
   * java.lang.String,boolean)
   */
  @Override
  public void deleteFromCollection(String collectionId, String fileName, boolean removeCollection)
          throws NotFoundException, IOException {
    File f = null;
   ...
   */
  String getMediaPackageElementDigest(String mediaPackageID, String mediaPackageElementID)
          throws IOException, IllegalStateException, NotFoundException {
    File f = getFile(mediaPackageID, mediaPackageElementID);
    if (f == null) {
   ...
   * {@inheritDoc}
   *
   * @see org.opencastproject.workspace.api.Workspace#getDiskSpace()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.opencastproject.workspace.api.Workspace#cleanupOldFilesFromCollection
   */
  @Override
    ...
    for (File f : colDir.listFiles()) {
      ...
      if (lastModified <= referenceTime) {
        ...
        try {
          ...
          // If it is already deleted, that is fine by us
        }
  ...
  public void cleanup(Id mediaPackageId, boolean filesOnly) throws IOException {
    final File mediaPackageDir = workspaceFile(
        Workspace.MEDIAPACKAGE_PATH_PREFIX, mediaPackageId.toString());
  ...
  private String getCollection(URI uri) {
    ...
    if (path.indexOf(Workspace.COLLECTION_PATH_PREFIX) < 0) {
